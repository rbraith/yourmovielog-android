...
data class SearchMultiResultMovie(
...
data class SearchMultiResultTv(
    @SerializedName("adult")
    val adult: Boolean,
    @SerializedName("backdrop_path")
    val backdropPath: String?,
...
data class SearchMultiResultPerson(
    @SerializedName("adult")
    val adult: Boolean,
    @SerializedName("id")
    val id: Int,
    ...
    override fun deserialize(
        ...
        return try {
            val deserializeType = when (json!!.asJsonObject.get("media_type").asString) {
                "movie" -> SearchMultiResultMovie::class.java
                "tv" -> SearchMultiResultTv::class.java
                "person" -> SearchMultiResultPerson::class.java
